...
int main(){
 ...
 try{
  ...
  int p1=ur.adaugaUtilizator("p1@edu.ro","p1","profesor"),p2=ur.adaugaUtilizator("p2@edu.ro","p2","profesor"),st=ur.adaugaUtilizator("s@edu.ro","s","student");profesor(db,p1);profesor(db,p2);student(db,st);
